...
> **Quick Start:** Run `$brand` in Codex to create a brand interactively. It can extract colors from a website URL, generate a palette from a single color, or let you specify colors manually.
