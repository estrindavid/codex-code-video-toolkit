...
```bash
gh issue create \
  --repo estrindavid/codex-code-video-toolkit \
...
✅ Safe to share:
   .agents/skills/video/SKILL.md (modified)
...
Found in projects/:
  ...
  1. digital-samba-skill-demo
     Marketing video for DS Codex skill
...
2. Edit `.agents/skills/contribute/SKILL.md` → Update `_internal/CHANGELOG.md`
