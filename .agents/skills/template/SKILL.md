...
⚠️  Restart Codex to see the new template in $video.
```
...
4. Update template README and AGENTS.md
...
2. Edit `.agents/skills/template/SKILL.md` → Update `_internal/CHANGELOG.md`
