...
Update the project's AGENTS.md with current state (see AGENTS.md Generation below).
...
Generate/update the project's AGENTS.md after any state change:
...
3. **Track sessions** - Help Codex understand context across sessions
4. **Auto-generate AGENTS.md** - Always-current human+Codex readable status
...
**Local improvements:**
1. Say "improve this" → Codex captures in `_internal/BACKLOG.md`
2. Edit `.agents/skills/video/SKILL.md` → Update `_internal/CHANGELOG.md`
3. Share upstream → `gh pr create`

**Remote contributions:**
- Issues: `github.com/estrindavid/codex-code-video-toolkit/issues`
