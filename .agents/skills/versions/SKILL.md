...
2. Fetch latest from GitHub API:
   https://api.github.com/repos/estrindavid/codex-code-video-toolkit/releases/latest
3. Compare versions
```
...
Restart Codex to load new skills and commands.
```
...
2. Edit `.agents/skills/versions/SKILL.md`
