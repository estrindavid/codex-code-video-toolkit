...
- **Codex native** — use bash tools to check, configure, and verify. This IS the setup wizard.
...
- **Codex**: Already running if they're seeing this command
...
- The command pattern itself could be useful for other Codex toolkits
