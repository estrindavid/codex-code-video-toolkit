# AGENTS.md - Digital Samba Skill Demo Video

## Project Overview

Marketing/blog video demonstrating the Digital Samba Codex skill. Shows the journey from skill installation to a working video conferencing app.
...
```
assets/
├── codex-code-install.gif      # Skill installation (1008x627)
├── codex-desktop-install.gif   # Alternative install (600x296)
```
...
# Convert GIFs
ffmpeg -i assets/codex-code-install.gif -movflags faststart -pix_fmt yuv420p remotion/public/demos/skill-install.mp4
